  ...
  return (
    <div className="min-h-screen bg-white pt-20 pb-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Action button: Sign In or GO LIVE */}
        {!user ? (
          <button
            onClick={handleSignIn}
            disabled={!canDeploy}
            className="comic-btn w-full text-lg py-4 disabled:opacity-30 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center gap-3"
          >
            ...
            SIGN IN WITH GOOGLE TO GO LIVE
          </button>
        ) : (
          <button

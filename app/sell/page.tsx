      ...
      <section className="max-w-5xl mx-auto px-4 py-16 md:py-20">
        <div className="comic-card p-8 md:p-12 text-center border-brand-yellow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
            ...
            {/* Social */}
            <a
              href="https://instagram.com/virelity"
              target="_blank"
            ...
            >
              ...
              <span className="font-display font-bold text-xs uppercase">Follow Us</span>
              <span className="text-xs text-brand-gray-medium font-body">@virelity</span>
            </a>
          </div>
